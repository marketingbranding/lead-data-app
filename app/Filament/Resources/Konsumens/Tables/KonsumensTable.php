...
class KonsumensTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('id_konsumen')->sortable()->hidden(),
                TextColumn::make('id_kavling')->label('Kavling')->sortable()->searchable(),
                TextColumn::make('nama_konsumen')->label('Nama Konsumen')->sortable()->searchable(),
                TextColumn::make('no_ktp')->label('No. KTP')->sortable()->searchable(),
                TextColumn::make('no_hp')->label('No. HP')->sortable()->searchable(),
                TextColumn::make('status_cash')
                    ->label('Skema')
                    ->badge()
