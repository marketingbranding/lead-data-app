...
namespace App\Filament\Resources\PpjbDevs\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('tanggal_sp3k')->date()->sortable(),
                TextColumn::make('tanggal_ttd_ppjb')->date()->sortable(),
            ...
            ->modifyQueryUsing(fn ($query) => $query->whereDoesntHave('kavling.akad'));
    }
}
